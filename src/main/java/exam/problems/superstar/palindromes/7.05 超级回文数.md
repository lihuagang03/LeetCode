...
# 7.05 超级回文数
> https://pintia.cn/problem-sets/2004497865353367552/exam/problems/type/7?problemSetProblemId=2004497865374339076

[906. 超级回文数](https://leetcode.cn/problems/super-palindromes/description/)
...
- `left` 和 `right` 不含前导零。
- `left` 和 rig`ht 表示的整数在区间 `[1, 1018 - 1]` 内。
- `left` 小于等于 `right` 。
